...
labels = tf.placeholder(tf.float32, [batchSize, numClasses], name = "InputLabel")
input_data = tf.placeholder(tf.int32, [batchSize, maxSeqLength], name = "InputData")
...
logdirModel = "models/" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S") + "/"
